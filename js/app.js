/* ============================================================
   ...
   Optimized for SEO, PWA, Accessibility & Performance
   ============================================================ */
...
// ============================================================
// TAB MANAGEMENT (dengan dukungan URL hash → SEO deep linking)
// ============================================================
...
function calculatePrice() {
  ...
  if (currentTab === 'dokumen') {
    ...
    // Fixed: tampilkan rincian yang benar
    summary = `
      <div class="flex justify-between"><span>Kategori:</span><strong class="text-white">${LABELS.paper[p]}</strong></div>
  ...
  // SEO/A11y: Announce perubahan ke screen reader
  if (priceEl) {
...
function sendOrderToWhatsApp() {
  ...
  const message = [
    ...
    '',
    '*FILE DESAIN:*',
    'Setelah pesan ini terkirim, saya akan mengirim file desain/berkas langsung melalui WhatsApp.',
    'Format yang disarankan: PDF, JPG, PNG, CDR, AI, PSD, DOC/DOCX, XLS/XLSX.',
    '',
  ...
  // Fallback untuk browser yang block window.open
  const win = window.open(url, '_blank', 'noopener,noreferrer');
  if (!win) window.location.href = url;
}

// ============================================================
// FAQ TOGGLE (hanya jika pakai <div> — versi lama)
// Untuk versi HTML terbaru yang pakai <details>, fungsi ini tidak dipakai.
...
window.addEventListener('beforeinstallprompt', e => {
  ...
  // Jangan tampilkan jika user sudah dismiss dalam 7 hari terakhir
...
// Sinkronisasi tab jika user klik link ke #kalkulator-xxx
